var File, PLUGIN_NAME, ProgressBar, async, childProcess, electron, fs, getApmPath, grs, isDir, isExists, isFile, mv, path, rm, spawn, through2, util, wrench;
  ...
  async.eachSeries(options.platforms, function(platform, callback) {
    ...
    return async.series([
      function(next) {
        ...
        return rm(releaseZipPath, function() {
