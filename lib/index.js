var Decompress, File, PLUGIN_NAME, PluginError, ProgressBar, Promise, async, chalk, changeName, childProcess, distributeApp, distributeBase, download, electron, fs, getApmPath, grs, isDir, isExists, isFile, mv, mvAsync, packaging, path, rm, rmAsync, signDarwin, spawn, through, unzip, util, wrench;
    ...
    return Promise.map(options.platforms, function(platform) {
      ...
      return new Promise(function(resolve, reject) {
        return Promise.resolve().then(function() {
          return download(cacheFile, cacheedPath, options.version, cacheZip);
        }).then(function() {
